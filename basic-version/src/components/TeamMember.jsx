...
const TeamMember = ({ member }) => {
  if (member.isLeader) {
    return (
      <div className="bg-cyber-darker border border-gray-700 border-l-4 border-l-cyber-green rounded-lg p-8 hover:border-cyber-green transition-all duration-300">
  ...
  return (
    <div className="bg-cyber-darker border border-gray-700 rounded-lg p-6 hover:border-cyber-green hover:-translate-y-1 transition-all duration-300 flex flex-col items-center text-center">
      ...
      <h3 className="text-white text-xl font-bold mb-4">{member.name}</h3>
